...
<main class="py-5">
    <section id="listado" class="mb-5">
        <div class="container">
            ...
            <a href="<?php echo FRONT_ROOT ?>Home/Logout4" style="width:49%" class="btn btn-danger btn-inline btn-lg">Volver al menu</a>
            <button type="submit" name="button" id="postulate" class="btn btn-primary btn-inline ml-auto btn-lg">Ver Postulación</button>
            <script>
