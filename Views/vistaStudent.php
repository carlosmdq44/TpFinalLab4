    ...
    <div class="content">
        <div class="login-form p-5 mb-2 bg-transparent text-white border border-primary">
            <div class="d-flex mb-5 justify-content-around bg-primary text-white">
                ...
                <a href="<?php echo FRONT_ROOT?>Job/ShowProfileView" class="btn btn-primary" aria-current="page">Jobs</a>
                <a href="<?php echo FRONT_ROOT?>User/ShowPersonalInformation" class="btn btn-primary" aria-current="page">Personal Information</a>
            </div>
