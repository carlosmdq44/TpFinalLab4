    ...
    <div class="content">
        <div class="login-form p-5 mb-2 bg-transparent text-white border border-primary">
            <div class="d-flex mb-5 justify-content-around bg-primary text-white">
                <a href="<?php echo FRONT_ROOT?>Job/ShowAddView" class="btn btn-primary px-5" aria-current="page">Add</a>
                <a href="<?php echo FRONT_ROOT?>Job/ShowProfileViewAdmin" class="btn btn-primary px-5" aria-current="page">List</a>
            </div>
            <div class="d-flex mb-5 justify-content-around bg-primary text-white">
            ...
            <a href="<?php echo FRONT_ROOT ?>Home/IndexAdmin" class="btn btn-danger btn-block btn-lg">Volver al menu</a>
        </div>
    </div>
</main>
